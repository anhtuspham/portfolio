        ...
        <div className="w-3/5 mx-auto max-xl:w-4/5">
          <div className="grid grid-cols-2 gap-5 max-md:grid-cols-1">
            <Board>
              ...
              >
                <p>
                  <span className="font-bold">Project Description</span>: A
                  movie website help user to find a favorite movie, review movie
                </p>
                <p>
                  <span className="font-bold">Function</span>: Show movie
                  details, search movies by keyword, responsive design that
                  scales based on device width, log-in/sign-up form with smooth
                  animation transitions between states.
                </p>
                <p>
                  <span className="font-bold">Technologies</span>: HTML, CSS,
                  Javascript to design template, API: Fetch movie detail from
                  OMDb API
                </p>
              </ListProject>
            </Board>
            <Board>
              ...
              >
                <p>
                  <span className="font-bold">Project Description</span>: Built
                  a framework to quickly create e-commerce or blog platforms,
